...
description: "Designs AWS cloud architectures, creates migration plans, cost optimization strategies, and DR plans. AWS-primary focus with Terraform as IaC. Invoke for Well-Architected reviews, VPC design, ECS/EKS architecture, Aurora/RDS sizing, CloudFront/WAF setup, multi-account strategies."
metadata:
  domain: infrastructure
  triggers: AWS, cloud migration, cloud architecture, cloud cost, Well-Architected, VPC design, ECS architecture, EKS, Aurora, landing zone, cloud security, disaster recovery, serverless, multi-account
  role: architect
