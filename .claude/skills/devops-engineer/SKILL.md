...
description: "Creates Dockerfiles, configures GitHub Actions CI/CD pipelines, manages ECS deployments with CodeDeploy blue-green, and handles infrastructure automation. Use when setting up CI/CD, containerizing applications, deploying to ECS/Kubernetes, automating releases, or responding to production incidents. Specializes in GitHub Actions OIDC, ECR, CodeDeploy, S3+CloudFront static deployments."
metadata:
  domain: devops
  triggers: DevOps, CI/CD, deployment, Docker, ECS, Kubernetes, Terraform, GitHub Actions, CodeDeploy, ECR, infrastructure, platform engineering, incident response, pipeline, blue-green
  role: engineer
